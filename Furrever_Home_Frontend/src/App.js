...
import AddVets from "./Admin/AddVets";
import ViewVets from "./Admin/ViewVets";
import EditVet from "./Admin/EditVet";
import ViewAllVets from "./Components/ViewAllVets";
      ...
      <Router>
        <AppLayout>
          <Routes>
            ...
            <Route path="/admin/addvets" element={<AddVets/>}></Route>
            <Route path="/admin/viewvets" element={<ViewVets/>}></Route>
            <Route path="/admin/editvet/:id" element={<EditVet/>}></Route>
            ...
            <Route path="/viewallvets" element={<ViewAllVets/>}/>
          </Routes>
        </AppLayout>
      </Router>
    </div>
